    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String degree=contactDetailsPanel.getDegreeField().getText();
            ...
            {    
             ...
             person.setData(name,mobile,email,degree,place);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().seteMail(detailPanel.geteMailField().getText());
         dialog.getPanel().setDegree(detailPanel.getDegreeField().getText());
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getDegreeField().setEditable(false);
          detailPanel.getPlaceField().setEditable(false);
        }
    }  //loadPersons ends
